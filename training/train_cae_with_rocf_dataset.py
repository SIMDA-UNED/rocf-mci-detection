...
Creation date: 19 december 2023.
'''
...
parser = argparse.ArgumentParser( description = 'train_cae_with_rocf_dataset' )
...
parser.add_argument( "--model_type", type = str, default = "CAE", help = "Choosing the model to be used for training." )
...
parser.add_argument( "--custom_training_epochs", type = int, default = 1200, help = "Training epochs." )
...
'''
Part 3. Global variables and constants.
'''
...
if __name__ == '__main__':
  ...
  for fold_index in range( 0, NUMBER_OF_FOLDS ):
    ...
    # For an autoencoder, the y is also the images (X).
    ...
    model = model_creator.convolutionalAutoEncoder(
